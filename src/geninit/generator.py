...
from geninit.models import Config, FileChange, GenerationPlan
...
def plan(
    ...
    *,
    ...
    if not resolved_roots:
        msg = "no package roots supplied; configure tool.geninit.roots or pass a path"
        raise ConfigurationError(msg)
